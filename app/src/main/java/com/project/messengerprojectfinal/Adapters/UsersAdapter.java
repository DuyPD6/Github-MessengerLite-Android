...
import com.project.messengerprojectfinal.ChatDetailActivity;
...
public class UsersAdapter extends RecyclerView.Adapter<UsersAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        Picasso.get().load(users.getProfilePic()).placeholder(R.drawable.ic_icons8_facebook2).into(holder.image);
